(function() {
  ...
  var app = angular.module("service.table.data", []);
  
  angular.module("service.table.data").factory("gridDataService", gridDataService);
  gridDataService.$inject = ['$http', '$q', 'alerting', 'URLS'];

  function gridDataService($http, $q, alerting, URLS) {
    ...
    //var URLS = {ITEMS: "../test/api.devices.items2.json", COGS: "../test/api.devices.cogs2.json", FACETS: "../test/api.devices.facets.json"};
